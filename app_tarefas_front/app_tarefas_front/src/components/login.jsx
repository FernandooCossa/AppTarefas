...
const FormularioLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (usarname.trim() === "" || senha.trim() === "") {
            alert("Preencha todos os campos!");
            return;
        }
    
        try {
            const response = await api.post("/login", { usarname, senha });
                    ...
                    <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">   
                        <form onSubmit={handleSubmit}>
                            <div className="form-outline mb-4">
                                <input type="text" id="usarname" className="form-control form-control-lg" value={usarname} onChange={(e) => setUsarname(e.target.value)} />
                                <label className="form-label" htmlFor="usarname">Usuário</label>
                            </div>
                            <div className="form-outline mb-4">
